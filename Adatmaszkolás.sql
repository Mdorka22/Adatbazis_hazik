CREATE TABLE [dbo].[Ugyfel](
	[LOGIN] [nvarchar](255) MASKED WITH (function = 'partial(2,"XXX",2)'),
	[EMAIL] [nvarchar](255) MASKED WITH (function = 'email()'),
	[NEV] [nvarchar](255) MASKED WITH (function='partial(3,"XXXXXXXX",3)'),
	[SZULEV] [int]  MASKED WITH (function='random(1900,2050)')NULL,
	[NEM] [nvarchar](1)  NULL,
	[CIM] [nvarchar](255) MASKED WITH(function='partial(0,"XXXXXXXX",5)') NULL,
...
CREATE user adatok without login
grant SELECT on Ugyfel to adatok
Execute as user='adatok'
Select * From Ugyfel
revert